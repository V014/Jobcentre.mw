...
<head>
    ...
    <title>About - TheJobCenter</title>
...
<body id="page-top" style="font-family: 'Open Sans', sans-serif;">
        ...
        <div class="container"><a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="assets/img/logo.png"></a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right" type="button" aria-controls="navbarResponsive"
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link js-scroll-trigger active" href="about-us.php">About us</a></li>
    ...
    <section id="feedback" style="padding: 200px 0px;">
        <div class="container text-center">
            ...
            <p>Our vision is to be the leading, most efficient provider of administrative, technical and industrial staff in Malawi and beyond; offering flexible staffing solutions that build efficiency and productivity, and providing Associates or Temps with rewarding temporary assignments or careers; and to strengthen the institutional capacity of organizations in Malawi and beyond</p>
        </div>
    </section>
    <!-- contacts -->
