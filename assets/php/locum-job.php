...
if(isset($_SESSION['ID'])){
	$Id = $_GET['id'];
	$queryJob = "SELECT v.Id, v.EmployerID, v.Title, v.Location, v.Qualifications, v.Experience, v.Salary, e.OrganisationName FROM `locum_vacancies` AS v INNER JOIN `locum_employer` AS e ON v.EmployerID = e.EmployerID WHERE v.Id = $Id";
